...
const GroupDescription = ({ group }) =>
  isDefaultGroup(group) ? (
    ...
    <div className="px2 text-measure">
      <p>
        {t`This is a special group whose members can see everything in the Foundry instance, and who can access and make changes to the
                settings in the Admin Panel, including changing permissions! So, add people to this group with care.`}
      </p>
      <p>
        {t`To make sure you don't get locked out of Foundry, there always has to be at least one user in this group.`}
      </p>
    </div>
  ) : null;
