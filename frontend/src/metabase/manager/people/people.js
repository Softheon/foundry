...
import { isAdminOnlyGroup } from "metabase/lib/groups";
...
// action constants
export const CREATE_USER = "metabase/manager/people/CREATE_USER";
export const FETCH_USERS = "metabase/manager/people/FETCH_USERS";
export const DEACTIVATE_USER = "metabase/manager/people/DEACTIVATE_USER";
export const REACTIVATE_USER = "metabase/manager/people/REACTIVATE_USER";
export const RESEND_INVITE = "metabase/manager/people/RESEND_INVITE";
export const RESET_PASSWORD_EMAIL =
  "metabase/manager/people/RESET_PASSWORD_EMAIL";
export const RESET_PASSWORD_MANUAL =
  "metabase/manager/people/RESET_PASSWORD_MANUAL";
export const SHOW_MODAL = "metabase/manager/people/SHOW_MODAL";
export const UPDATE_USER = "metabase/manager/people/UPDATE_USER";
export const LOAD_GROUPS = "metabase/manager/people/LOAD_GROUPS";
export const LOAD_MEMBERSHIPS = "metabase/manager/people/LOAD_MEMBERSHIPS";
export const LOAD_GROUP_DETAILS = "metabase/manager/people/LOAD_GROUP_DETAILS";

export const CREATE_MEMBERSHIP = "metabase/manager/people/CREATE_MEMBERSHIP";
export const DELETE_MEMBERSHIP = "metabase/manager/people/DELETE_MEMBERSHIP"
...
export const deactivateUser = createThunkAction(
  ...
  user => async () => {
    ...
    MetabaseAnalytics.trackEvent("People Manager", "User Removed");
...
export const reactivateUser = createThunkAction(
  ...
  user => async () => {
    ...
    MetabaseAnalytics.trackEvent("People Manager", "User Reactivated");

    return newUser;
  },
);

export const fetchUsers = createThunkAction(
  FETCH_USERS,
  () => async () => {
...
export const resendInvite = createThunkAction(
  RESEND_INVITE,
  user => async () => {
    MetabaseAnalytics.trackEvent("People Manager", "Resent Invite");
...
export const resetPasswordManually = createThunkAction(
  ...
  (user, password) => async () => {
    MetabaseAnalytics.trackEvent("People Manager", "Manual Password Reset");
...
export const resetPasswordViaEmail = createThunkAction(
  ...
  user => async () => {
    MetabaseAnalytics.trackEvent("People Manager", "Trigger User Password Reset");
...
export const updateUser = createThunkAction(
  UPDATE_USER,
  user => async () => {
    MetabaseAnalytics.trackEvent("Peiple manager", "Update Updated");
...
const groups = handleActions(
  {
    [LOAD_GROUPS]: {
      next: (state, { payload }) =>
        payload && payload.filter(group => !isAdminOnlyGroup(group))
    }
  },
  null
);
