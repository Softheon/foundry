...
import { getGroup, getGroups, getUsers } from "../selectors.js";
import { loadGroups, loadGroupDetails, fetchUsers } from "../people.js";
...
export default class GroupDetailApp extends Component {
  async componentWillMount() {
    ...
    console.log("group id", this.props.params.groupId);
