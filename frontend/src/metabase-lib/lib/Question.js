...
export default class Question {
  ...
  /**
   * The plain object presentation of this question, equal to the format that Foundry REST API understands.
   ...
   * This way we benefit from caching and query optimizations done by Foundry backend.
   */
  async apiGetResults({
    cancelDeferred,
    isDirty = false,
