(ns metabase.models.pulse
  "Notifcations are ways to deliver the results of Questions to users without going through the normal Foundry UI. At
  ...
  Foundry models. There is a plethora of CRUD functions for working with Pulses that IMO aren't really needed (e.g.
