(ns metabase.plugins.lazy-loaded-driver
  ...
  See https://github.com/metabase/metabase/wiki/Foundry-Plugin-Manifest-Reference for all the options allowed for a
  plugin manifest."
...
(defn register-lazy-loaded-driver!
  "Register a basic shell of a Foundry driver using the information from its Foundry plugin"
  ...
  (let [driver           (keyword driver-name)
    ...
    ;; finally, register the Foundry driver
