(ns metabase.util.urls
  "Utility functions for generating the frontend URLs that correspond various user-facing Foundry *objects*, like Cards or Dashboards.
   ...
   Functions for generating URLs not related to Foundry *objects* generally do not belong here, unless they are used in many places in the
