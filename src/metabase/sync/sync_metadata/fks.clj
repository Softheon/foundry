...
(s/defn ^:private fetch-fk-relationship-objects :- (s/maybe FKRelationshipObjects)
  "Fetch the Foundry objects (Tables and Fields) that are relevant to a foreign key relationship described by FK."
...
(s/defn sync-fks!
  "Sync the foreign keys in a DATABASE. This sets appropriate values for relevant Fields in the Foundry application DB
