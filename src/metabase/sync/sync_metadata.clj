(ns metabase.sync.sync-metadata
  "Logic responsible for syncing the metadata for an entire database.
   ...
   4.  Sync Foundry Metadata table (`metabase.sync.sync-metadata.metabase-metadata`)"
...
(s/defn sync-db-metadata!
  "Sync the metadata for a Foundry DATABASE. This makes sure child Table & Field objects are synchronized."
