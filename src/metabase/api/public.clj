(ns metabase.api.public
  "Foundry API endpoints for viewing publicly-accessible Cards and Dashboards."
...
(api/defendpoint GET "/oembed"
  "oEmbed endpoint used to retreive embed code and metadata for a (public) Foundry URL."
