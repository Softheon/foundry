...
(defproject metabase "metabase-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.10.0"]
                 ...
                 [honeysql "0.9.4"                                    ; Transform Clojure data structures to SQL
                 ...
                 [io.forward/yaml "1.0.9"                             ; Clojure wrapper for YAML library SnakeYAML (which we already use for liquidbase)
                  :exclusions [org.clojure/clojure
                               org.yaml/snakeyaml]]
                 [kixi/stats "0.4.4"                                  ; Various statistic measures implemented as transducers
  ...
  :ring {:handler metabase.handler/app
